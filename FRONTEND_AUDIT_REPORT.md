...
2.  **Mode Switcher** (Sculpt/Glaze - nested *inside* the sidebar)
...
-   **Context Aware Panel:**
    -   If *Sculpting*: Shows Parametric Sliders (Twist, Taper, Physics).
    -   If *Glazing*: Shows Color Mixer and Kiln settings.
    -   If *Exporting*: Shows Format options (STL, GLB).
