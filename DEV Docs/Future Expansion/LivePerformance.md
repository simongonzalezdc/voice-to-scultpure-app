...
We are forking the codebase. The CAD version focuses on _Accuracy and Manufacturing_. This new project focuses on _Latency, Spectacle, and Interoperability_.
...
- **Flow:**
  - _Song 1 (Ballad):_ Blue/Purple palette, Slow drift, Sphere shape.
  - _Song 2 (Techno):_ Red/White strobe, Glitch camera, Cube shape.
...
- _Ideal Setup:_ The projector shows the "Clean Feed." The laptop screen shows the "Dashboard."
- **Dashboard Modules:**
