...
<div
	class="session-history rounded-xl border border-white/10 bg-black/30 backdrop-blur-sm overflow-hidden"
	class:compact
>
	...
	{#if !compact}
		<div
			class="px-3 py-2 bg-black/20 border-t border-white/5 text-xs text-white/30 flex justify-center gap-4"
		>
